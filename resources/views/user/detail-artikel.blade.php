...
<div class="max-w-7xl mx-auto px-8 py-8">
    ...
    <div class="text-xs text-gray-500 mb-8">
        ...
        <a href="/artikel" class="hover:text-[#173F7A]">
            Artikel Terbaru
        </a>
    ...
    <div class="mb-4">
        ...
        <h2 class="text-2xl md:text-3xl font-bold text-[#173F7A] leading-tight">

            Siswa PPLG SMKN 4 Bogor Juara 2 TECHN0UPDATE X HIMPACT
    ...
    {{-- ================= ARTIKEL ================= --}}
    <article class="bg-white rounded-lg border border-gray-200 shadow-md overflow-hidden">

        {{-- FOTO ARTIKEL --}}
        <div class="relative">

            <img
                src="{{ asset('images/artikel1.jpg') }}"
                alt="Siswa PPLG SMKN 4 Bogor"
        ...
        <div class="px-7 py-6">
            ...
            <p class="text-sm text-gray-700 leading-relaxed">
                ...
                SMK Negeri 4 Bogor Mengucapkan Selamat dan Sukses
                Kepada Sabih Ahmad Khairi, Muhammad Farid Adilah
                Handi, dan Muhammad Davi Najamuddin Anshori dari
                Konsentrasi Keahlian PPLG atas pencapaian prestasi
                yang telah meraih juara 2 TECHN0UPDATE X HIMPACT
                2025 yang dilaksanakan pada Konstsite Jakarta pada
                Hari Kamis, 16 Oktober 2025.
